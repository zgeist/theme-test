...
/**
 * Output socials icons action
 */
function site_socials_icons_list_action() {

	echo fw_render_view( get_stylesheet_directory() . '/inc/views/social-links.php', array(
		'icons' => fw_get_db_settings_option( 'social_icons', array() )
	) );

}
add_action( 'site_socials_icons_list', 'site_socials_icons_list_action' );

/**
 * Output sign up newsletter button action
 */
function site_signup_newsletter_button_action() {

	echo fw_render_view( get_stylesheet_directory() . '/inc/views/signup-newsletter-button.php', array(

	) );

}
add_action( 'site_signup_newsletter_button', 'site_signup_newsletter_button_action' );

function site_copyright_action() {

	echo fw_get_db_settings_option( 'copyright', '' );

}
add_action( 'site_copyright', 'site_copyright_action' );

function site_subscribe_modal() {

	echo fw_render_view( get_stylesheet_directory() . '/inc/views/subscribe-modal.php', array(
